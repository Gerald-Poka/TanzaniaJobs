...
<head>
    <?php echo $this->render('/JobPortal/System/User/partials/title-meta', array('title' => 'Update Referee')); ?>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="form-section card">
                                <div class="form-section-header card-header">
                                    ...
                                    <h5 class="mb-0">Update Referee Information</h5>
                                </div>
                            ...
                            <div class="form-section card">
                                <div class="form-section-body card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <?= Html::submitButton('<i class="ri-save-line me-1"></i> Update Referee', [
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">
                                        <i class="ri-lightbulb-line text-warning me-2"></i>Tips for Referees
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div class="alert alert-info">
                                        ...
                                        <ul class="mb-0">
                                            <li>Keep referee information up to date</li>
                                            <li>Inform referees when you're job hunting</li>
                                            <li>Provide context about the roles you're applying for</li>
                                            <li>Thank them for their time and support</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
