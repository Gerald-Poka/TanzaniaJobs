...
<head>
    <?php echo $this->render('../partials/title-meta', ['title' => 'Rejected Applications']); ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Rejected Applications</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">Rejected Applications Management</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <?= GridView::widget([
                                        ...
                                        'summary' => 'Showing {begin}-{end} of {totalCount} rejected applications',
