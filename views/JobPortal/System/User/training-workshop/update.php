...
$this->title = 'Update Training/Workshop';
...
<head>
    <?php echo $this->render('/JobPortal/System/User/partials/title-meta', array('title' => 'Update Training/Workshop')); ?>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="form-section card">
                                <div class="form-section-header card-header">
                                    ...
                                    <h5 class="mb-0">Update Training/Workshop Information</h5>
                                </div>
                            ...
                            <div class="form-section card">
                                <div class="form-section-body card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <?= Html::submitButton('<i class="ri-save-line me-1"></i> Update Training/Workshop', [
