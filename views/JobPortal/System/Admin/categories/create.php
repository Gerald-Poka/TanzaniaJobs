...
<head>
    <?php echo $this->render('../partials/title-meta', array('title'=>'Create Category')); ?>
        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('../partials/page-title', array('pagetitle'=>'Job Management', 'title'=>'Create Category')); ?>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">
                                        <i class="ri-add-circle-line me-2"></i>Create New Category
                                    </h5>
                                </div>
                                <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="icon-preview">
                                                            <i class="ri-folder-line" id="selected-icon"></i>
                                                        </span>
                                                        <input type="text" class="form-control" id="icon" name="icon" placeholder="ri-folder-line" value="ri-folder-line">
                                        ...
                                        <div class="card mt-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="meta_description" name="meta_description" rows="3" placeholder="SEO description for search engines"></textarea>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        ...
                                        <span class="badge bg-success-subtle text-success" id="preview-status">Active</span>
                                    </div>
                                </div>
                            </div>
        ...
        $(document).ready(function() {
            ...
            $('#createCategoryForm').on('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    html: 'Please wait while we create the category',
            ...
            // Set default icon active state
            $('.icon-option[data-icon="ri-computer-line"]').removeClass('btn-outline-primary').addClass('btn-primary');
            
            // Initialize preview with current values
            updateIcon('ri-folder-line');
            $('#preview-name').text('Category Name');
            $('#preview-description').text('Category description will appear here...');
        });
    </script>
