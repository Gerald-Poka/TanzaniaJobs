...
<head>
    <?php echo $this->render('/JobPortal/System/User/partials/title-meta', array('title' => 'Add Work Experience')); ?>
...
<body>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="form-section card">
                                <div class="form-section-header card-header">
                                    ...
                                    <h5 class="mb-0">Work Experience Information</h5>
                                </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-check mb-3">
                                                <?= $form->field($model, 'is_current')->checkbox([
                                                    ...
                                                    'id' => 'is-current-job'
                                                ])->label('I currently work here', ['class' => 'form-check-label']) ?>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-section card">
                                <div class="form-section-body card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <?= Html::submitButton('<i class="ri-save-line me-1"></i> Save Work Experience', [
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="alert alert-info">
                                        <h6 class="alert-heading">Make it impactful!</h6>
                                        <ul class="mb-0">
                                    ...
                                    <div class="alert alert-warning">
                                        ...
                                        <ul class="mb-0">
                                            ...
                                            <li>Include relevant skills for each role</li>
                                            <li>Be honest about dates and responsibilities</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const isCurrentCheckbox = document.getElementById('is-current-job');
